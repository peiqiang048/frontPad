	...
	<view class="container" v-bind:style="{ height: windowHeight + 'px' }">
		<view class="menuLine">
			...
			<view class="returnLable">
				<view>{{i18n.seisan}}</view>
			</view>
		</view>
		<!--情報入力  -->
		<view style="border-bottom: 1px solid #4e759b;font-size: 48%;text-align: center;">{{i18n.information}}</view>
		<digitKeyboard :keyBoardTop="keyBoardTop" :keyBoardLeft="keyBoardLeft" v-if="isShowKeyboardWindow" @cancel="keyBoardHid" @confirm="keyboardConfirm" />
		...
		<view class="table-loft" style="height: 70%;width: 48%;">
			<view class="table-responsive" style="width: 94%;margin: 2% 3% 0% 3%;overflow-x: scroll;overflow-y: hidden;">
				...
				<div style="height:100%;width:100%;overflow:scroll;background:#EEEEEE;">
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a" @tap="selectInput('num1')" v-model="num1" disabled="true" v-on:change="getnum1()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num1'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a" @tap="selectInput('num2')" disabled="true" v-model="num2" v-on:change="getnum2()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num2'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num3')" v-model="num3" disabled="true" v-on:change="getnum3()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num3'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num4')" v-model="num4" disabled="true" v-on:change="getnum4()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num4'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num5')" disabled="true" v-model="num5" v-on:change="getnum5()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num5'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num6')" disabled="true" v-model="num6" v-on:change="getnum6()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num6'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num7')" disabled="true" v-model="num7" v-on:change="getnum7()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num7'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num8')" disabled="true"  v-model="num8" v-on:change="getnum8()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num8'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num9')" disabled="true" v-model="num9" v-on:change="getnum9()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num9'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						...
						<!-- 枚数 -->
						<input class="transferSecondTho-a"  @tap="selectInput('num10')" disabled="true" v-model="num10" v-on:change="getnum10()" type="number" pattern="\d*" :style="{'background-color':tapInput==='num10'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
						<!-- 合計 -->
			...
			<view class="menuLine-s">
				...
				<input class="input-a"  @tap="selectInput('total')" disabled="true" v-model="total" v-on:change="gettotal()" type="text" :style="{'background-color':tapInput==='total'&& isShowKeyboardWindow?'#F0F8FF':''}">
			...
			<view class="table-responsive" style="width: 96%;margin: 2% 5% 0% 3%;overflow-x: scroll;overflow-y: hidden;">
				...
				<div style="height:100%;width:100%;overflow:scroll;background:#EEEEEE;">
					...
					<view class="transferSecondTro-a">
						...
						<!--  -->
						<view class="transferSecondTho" style="width:20%;text-align: right;">e＝d+f‐c</view>
						<!-- 合計 -->
					...
					<view class="transferSecondTro-a">
						<!-- 出金 -->
						<view class="transferSecondTho" style="width:33%;text-align: left;">{{i18n.outAmount}}</view>
						<view class="transferSecondTho" style="width:20%;text-align: right;">f</view>


						<input class="transferSecondTho-a" @tap="selectInput('siyukin')" disabled="true" v-model="siyukin" v-on:change="getsiyukin()" type="text"  style="margin-left: 5.5%;" :style="{'background-color':tapInput==='siyukin'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
					</view>

					<view class="transferSecondTro-a">
						<!-- 銀行預入額 -->
						<view class="transferSecondTho" style="width:33%;text-align: left;">{{i18n.bankDepositAmount}}</view>
						<view class="transferSecondTho" style="width:20%;text-align: right;">g＝d‐h</view>

						<input class="transferSecondTho-a" @tap="selectInput('ginkoatugarikin')" disabled="true" v-model="ginkoatugarikin" v-on:change="getginkoatugarikin()" type="text"
						 pattern="\d*" style="margin-left:  5.5%;" :style="{'background-color':tapInput==='ginkoatugarikin'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">

					</view>
					<view class="transferSecondTro-a">
						<!-- 翌日繰越金 -->
						<view class="transferSecondTho" style="width:33%;text-align: left;">{{i18n.nextDayTransferredAmount}}</view>
						<view class="transferSecondTho" style="width:20%;text-align: right;">h＝d‐g</view>

						<input class="transferSecondTho-a" @tap="selectInput('yokujitukurikosikin')" disabled="true" v-model="yokujitukurikosikin" v-on:change="getyokujitukurikosikin()" type="text"
						 pattern="\d*" style="margin-left:  5.5%;" :style="{'background-color':tapInput==='yokujitukurikosikin'&& isShowKeyboardWindow?'#F0F8FF':'#FFFFFF'}">
					</view>



					<view style="float:left;height:15%;width: 100%;overflow-y: auto;"></view>

				</div>

			</view>
			<view class="menuLine-a">
				<view class="returnLable-a">{{i18n.purchasingCost}}</view>

				<input class="input-a" type="text" @tap="selectInput('genka')" disabled="true" v-model="genka" v-on:change="getgenka()" :style="{'background-color':tapInput==='genka'&& isShowKeyboardWindow?'#F0F8FF':''}">
				<img src="static/button_x.png" style="margin: 0;width:5%;height:60%; margin-top:8px;margin-right: 3%;"  @click="cleargenka()"></image>
			</view>
			<view class="returnLable-s1">{{i18n.purchasingCostMessage}}</view>
		...
		<view v-show="showalert">
			...
			<view class="sweet-alert">
				...
				<view class="sa-button-container">
					<!-- 取消按钮 -->
					<button v-if="confirmStatus === 1 || confirmStatus === 2" style="display: inline-block; background-color: #adadad"
					 @click="cancelButton">{{i18n.cancelAccountShare}}</button>
					<!-- 确认按钮 -->
...
<script>
	...
	var openCashDoorModule = uni.requireNativePlugin("CashDoorService");
	...
	export default {
		...
		methods: {
			...
			selectInput(index){
				...
				if(index === 'num3'){
					this.isShowKeyboardWindow = true;
					this.keyBoardTop = this.windowHeight * 0.5;
					this.keyBoardLeft = this.windowWidth * 0.3;
				}
				...
				if(index === 'num7'){
					this.isShowKeyboardWindow = true;
					this.keyBoardTop = this.windowHeight * 0.7;
					this.keyBoardLeft = this.windowWidth * 0.3;
				}
				...
				if(index === 'siyukin'){
					this.isShowKeyboardWindow = true;
					this.keyBoardTop = this.windowHeight * 0.6;
					this.keyBoardLeft = this.windowWidth * 0.5;
				}
				
				if(index === 'ginkoatugarikin'){
					this.isShowKeyboardWindow = true;
					this.keyBoardTop = this.windowHeight * 0.6;
					this.keyBoardLeft = this.windowWidth * 0.5;
				}
				
				if(index === 'yokujitukurikosikin'){
					this.isShowKeyboardWindow = true;
					this.keyBoardTop = this.windowHeight * 0.6;
					this.keyBoardLeft = this.windowWidth * 0.5;
				}
			...
			keyboardConfirm(val) {
				...
				if (this.tapInput === 'siyukin') {
					this.siyukin = val;
					this.getsiyukin();
				}
				
				if (this.tapInput === 'ginkoatugarikin') {
					this.ginkoatugarikin = val;
					this.getginkoatugarikin();
				}
				
				if (this.tapInput === 'yokujitukurikosikin') {
					this.yokujitukurikosikin = val;
					this.getyokujitukurikosikin();
				}
				
				if (this.tapInput === 'genka') {
					this.genka = val;
					this.getgenka();
				}
			...
			getnum1: function() {
				...
				//算出现金差异
				this.genkinsai = this.genkingokei - this.jisaigenkingokei + Number(this.deleteMark(this.siyukin));
			...
			getsiyukin: function() {
				...
				//出金不能出现多个零
				siyukin = Number(siyukin).toString();
				//实际收银台金额转换成纯数值
			...
			getginkoatugarikin: function() {
				...
				//翌日繰越金額转换成纯数值
				this.yokujitukurikosikin = this.yokujitukurikosikin.replace(/[^0-9]/isg, "");
				//銀行預入金額不能出现多个零
				ginkoatugarikin = Number(ginkoatugarikin).toString();

				//翌日繰越金額转换成纯数值
				yokujitukurikosikin = this.jisaigenkingokei - ginkoatugarikin;
				if(yokujitukurikosikin < 0){
					//取绝对值后加符号"-￥"翌日繰越金
					yokujitukurikosikin = Math.abs(yokujitukurikosikin);
			...
			getyokujitukurikosikin: function() {
				...
				//翌日繰越金不能出现多个零
				yokujitukurikosikin = Number(yokujitukurikosikin).toString();
				// 銀行預入金額
				this.ginkoatugarikin = jisaigenkingokei - yokujitukurikosikin;
				if(this.ginkoatugarikin<0){
					//取绝对值后加符号"-￥"銀行預入金額
					this.ginkoatugarikin = Math.abs(this.ginkoatugarikin);
			...
			genkinsaihandan: function() {
				//现金差异判断
				if (this.genkingokei > this.jisaigenkingokei + Number(this.deleteMark(this.siyukin))) {
					//现金差异绝对值
			...
			loadAmountSold: function() {
				const data = {
					...
					//精算区分
					settleType: "1",
					inspectionSettleDate: this.inspectionSettleDate
				...
				http.post('api/stpd/getInspectionSettleInit', data)
					.then(result => {
						if (result.data.resultCode === '0000') {
							...
							// 精算２回以上
							if (result.data.inspectionSettleDate !== null && result.data.inspectionSettleDate !== undefined && result.data
								.inspectionSettleDate !== "") {
								this.inspectionSettleDate = result.data.inspectionSettleDate;
								this.showalert = true;
								this.tipMessage = this.i18n.onceAgainSettle;
			...
			drawerOpen: function() {
				...
				http.post('api/stpd/openCashDoor', data)
					.then(result => {
						if (result.data.resultCode === '0000') {
							openCashDoorModule.openCashDoor(result.data.printIp,
								(ret) => {})
						} else if (result.data.resultCode === '9001') {
							// 参数校验失败
							this.showalert = true;
				...
				http.post('api/stpd/inspectionSettle', data)
					.then(result => {
						if (result.data.resultCode === '0000') {
							...
							// 参数校验失败
							this.showalert = true;
							this.tipMessage = this.i18n.settleOk;
							// 隐藏加载画面
							this.$hideLoading();
						} else if (result.data.resultCode === '9001') {
							// 参数校验失败
