		...
		<view class="e-picker" :style="{'visibility':pickerVisible?'visible':'hidden'}">
			...
			<view class="e-picker-container" :class="{'e-picker-container--show':pickerVisible,'e-picker-animation':animation}">
				<view class="e-picker-action">
					<view class="e-picker-action--cancel" @tap="_cancel">{{i18n.cancel}}</view>
					<view class="e-picker-action--confirm" @tap="_confirm">{{i18n.confirm}}</view>
				</view>
...
<script>
	import utils from '@/components/e-picker-plus/utils.min.js'
	export default {
		name: 'ePickerPlus',
		// 引入多语言文件
